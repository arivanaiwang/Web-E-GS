...
<div class="main-content p-8 ml-0 transition-all duration-300 fade-in">
    ...
    <section class="content-section mb-8">
        ...
        <img src="https://images.pexels.com/photos/1723913/pexels-photo-1723913.jpeg" alt="Kerang Hijau" class="rounded-lg shadow-lg w-full md:w-1/2 mx-auto">
    </section>
    ...
    <div class="mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="feature-card bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                ...
                <img src="https://images.pexels.com/photos/1749754/pexels-photo-1749754.jpeg" alt="Penangkapan Kerang Hijau" class="w-full rounded-lg shadow-md">
            </div>
            ...
            <div class="feature-card bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                ...
                <img src="https://images.pexels.com/photos/2360556/pexels-photo-2360556.jpeg" alt="Rencana Penangkapan" class="w-full rounded-lg shadow-md">
            </div>
            ...
            <div class="feature-card bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                ...
                <img src="https://images.pexels.com/photos/2473627/pexels-photo-2473627.jpeg" alt="Biodata Nelayan" class="w-full rounded-lg shadow-md">
            </div>
        </div>
    </div>
</div>
